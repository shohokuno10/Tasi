...
def main():
    ...
    adx_min = st.number_input("ADX最小值 (強勢指標 如25)", min_value=0.01, value=25.0, step=0.01)
    ...
    atr_threshold = st.number_input("ATR閾值 (波動指標如0.2)", min_value=0.01, value=0.2, step=0.01)
